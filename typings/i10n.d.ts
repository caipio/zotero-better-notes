...
export type FluentMessageId =
  ...
  | 'editor-title'
  | 'editor-toolbar-markdownMode'
  | 'editor-toolbar-md-blockquote'
  | 'editor-toolbar-md-bold'
  | 'editor-toolbar-md-bulletList'
  | 'editor-toolbar-md-citation'
  | 'editor-toolbar-md-clearFormat'
  | 'editor-toolbar-md-code'
  | 'editor-toolbar-md-heading'
  | 'editor-toolbar-md-highlightColor'
  | 'editor-toolbar-md-italic'
  | 'editor-toolbar-md-link'
  | 'editor-toolbar-md-orderedList'
  | 'editor-toolbar-md-paragraph'
  | 'editor-toolbar-md-removeColor'
  | 'editor-toolbar-md-search'
  ...
  | 'keepLink'
  | 'latex-merge'
  | 'libraryGraph-allLibraries'
  | 'libraryGraph-empty'
  | 'libraryGraph-indexing'
  | 'libraryGraph-rescan'
  | 'libraryGraph-rescan-tooltip'
  | 'libraryGraph-searchPlaceholder'
  | 'libraryGraph-showUnlinked'
  | 'libraryGraph-stats'
  | 'libraryGraph-title'
  | 'links-embed'
  | 'links-keep'
